...
#:
#: Один час за реальную минуту — в шестьдесят раз медленнее активной игры на 1x
#: (DESIGN.md, §Р5). Курс «час за секунду», взятый сначала как самое защитимое
#: умолчание, превращал учебную неделю в семьдесят игровых лет: при необратимом
#: банкротстве это означало, что игра наказывает за учёбу.
#:
#: Кандидат на калибровку в фазе 2, когда станет видно, на каком горизонте
#: решения игрока успевают что-то значить (BALANCE.md, §1).
CATCHUP_TICKS_PER_SECOND = 1.0 / 60.0
